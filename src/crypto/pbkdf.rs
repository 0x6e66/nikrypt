...
impl_pbkdf2!(pbkdf2_sha384, crate::crypto::hmac::hmac_sha384);
...
mod tests {
    ...
    fn case1() {
        ...
        let sha384_dk = pbkdf2_sha384(p, s, c, dk_len);
        let sha384_correkt_key = vec![
        ...
        assert_eq!(sha384_correkt_key, sha384_dk);
    ...
    fn case3() {
        ...
        let sha384_dk = pbkdf2_sha384(p, s, c, dk_len);
        let sha384_correkt_key = vec![
            0x13, 0xfb, 0x47, 0x0d, 0x78, 0x6c, 0xbe, 0x36, 0x2a, 0xec, 0x83, 0x01, 0x7e, 0xca,
            0xbc, 0xca, 0xb1, 0x6b, 0x96, 0xc4, 0x17, 0xc6, 0xb8, 0xb6, 0x7a, 0x2d, 0xdb, 0x0c,
            0x26, 0x12, 0xe0, 0xc3, 0x0e, 0x37, 0xa5, 0x93, 0xde, 0x9d, 0xd2, 0xf1,
        ];
